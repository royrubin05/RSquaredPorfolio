                    ...
                    {isSafe ? (
                        ...
                        <>
                            <div className="w-24">
                                ...
                                <div className="font-mono text-sm text-foreground">{formatCurrencyDisplay((valuation && valuation !== '-') ? valuation : originalSafeTerms?.valuation_cap, 'compact')}</div>
                            </div>
            ...
            {originalSafeTerms && (
                <div className="bg-gray-50/50 border-t border-gray-100 px-6 py-3 flex items-center gap-4 text-xs">
                    ...
                    <div className="flex-1 flex items-center bg-white border border-gray-100 rounded-md px-4 py-2 shadow-sm relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-6 relative z-10 justify-start w-full">
                            {/* Origin */}
                            <div className="flex flex-col items-start gap-0.5 min-w-[120px]">
                                <div className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold flex items-center gap-1">
                                    Original SAFE
                                </div>
                                <div className="font-mono text-gray-700 font-medium whitespace-nowrap text-xs">
                            ...
                            <div className="flex flex-col items-start gap-0.5">
                                ...
                                <div className="flex items-center gap-6 text-xs">
                                    ...
                                    {/* Ownership */}
                                    <div className="flex flex-col">
                                        <span className="text-[9px] text-gray-400 font-medium uppercase tracking-wide">Ownership</span>
                                        <span className="font-mono text-gray-700 font-medium">
                                            {allocations && allocations.length > 0 ? (
